<?php if (have_rows('testimonial')): ?>
            ...
            <section class="testimonial-section">
                ...
                <?php if (get_row_layout() == 'testimonial_left_layout'): ?>
                    <div class="row">
                        <!-- Left Column: Image -->
                        <div class="col-12 col-md-4 testimonial-left" style="background-image: url('<?php echo esc_url(get_sub_field('testimonial_left_image')); ?>');">
                        <!-- Left Div: Image -->
                        </div>
                        ...
                        <div class="col-12 col-md-8 testimonial-right d-flex flex-column justify-content-center">
                            <?php if (have_rows('testimonial_card')): ?>
                                <div class="testimonial-cards">
                                    <?php 
                                    $card_count = 0; // Initialize card count for navigation
                                    ...
                                    ?>
                                        <div class="testimonial-card mb-4" id="testimonial-card-<?php echo $card_count; ?>" style="display: <?php echo $card_count === 1 ? 'block' : 'none'; ?>;">
                                            <div class="testimonial-content">
                                                ...
                                                <p class="testimonial-text"><?php echo esc_html(get_sub_field('text')); ?></p>
                                                <p class="testimonial-author">
                                                    <div class="testimonial-icon mb-3">
                                                        <img src="<?php echo esc_url(get_sub_field('icon')); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>" class="img-fluid">
                                                        <div class="author-div">
                                                            <p class="author-name"><?php echo esc_html(get_sub_field('name')); ?></p>
                                                            <p class="author-position"><?php echo esc_html(get_sub_field('position')); ?></p>
                                                        </div>
                                                    </div>
                                                </p>
                                            </div>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>No testimonial section available.</p>
        <?php endif; ?>
    </div>
</section>
