...
<section class="testimonial-section">
    <div class="container cta-container">
        <div class="row">
            <div class="col-md-4 col-12 testimonial-left" style="background-image: url('<?php echo $testimonial_left_image; ?>');"></div>
            <div class="col-md-8 col-12 testimonial-right d-flex flex-column justify-content-center">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.prev-testimonial').forEach((prevButton, index) => {
            prevButton.addEventListener('click', function () {
                currentCard = (currentCard > 0) ? currentCard - 1 : testimonialCards.length - 1;
        ...
        document.querySelectorAll('.next-testimonial').forEach((nextButton, index) => {
            nextButton.addEventListener('click', function () {
                currentCard = (currentCard < testimonialCards.length - 1) ? currentCard + 1 : 0;
                showCard(currentCard);
            });
        });
